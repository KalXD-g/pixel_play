...
color_map={1:(0,0,255),2:(0,155,255),3:(0,255,255),4:(0,255,0),5:(255,0,0),6:(255,0,255)}
...
incident_ray=(upper_ref[0]+int((upper_ref[1]-center[1])*math.tan(inc_angle_rad)),upper_ref[1])
refract_ray=(lower_ref[0]+int((lower_ref[1]-center[1])*math.tan(refract_angle)),lower_ref[1])
...
cv.putText(screen,str(inc_angle_deg),(50,120),cv.FONT_HERSHEY_SIMPLEX,0.35,(0,255,255),1)
