...
calculated_point_incident_ray = (upper_reference_point[0] + int(
    (upper_reference_point[1]-centre_point[1])*math.tan(incident_angle_rad)), upper_reference_point[1])

# Calculating endpoint for refracted ray
calculated_point_refracted_ray = (lower_reference_point[0] + int(
    (lower_reference_point[1]-centre_point[1])*math.tan(refraction_angle)), lower_reference_point[1])
